...
<div class ="container-fluid">
        <nav class=" shadow p-3 mb-3 bg-white rounded navbar navbar-expand-lg navbar-light flex-row">
          <a href="javascript:history.back()"><img src="<?php echo url_for('/images/smallback.png'); ?>"/></a>
            <a class= "mx-auto" href="<?php echo url_for('/staff/index.php'); ?>"><img class="navbar-brand" src="<?php echo url_for('/images/vMedLogo.png'); ?>" alt="logo"/></a>
        </nav>
      </div>
