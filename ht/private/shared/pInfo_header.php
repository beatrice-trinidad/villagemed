...
<div class = "container-fluid">
  <div class ="row">
    ...
    <label for="staticName" class="col-md-5 col-form-label">Non</label>
    <div class="col-md-7">
  ...
  <div class="row row-bottom-margin">
    <label for="staticGender" class="col-md-5 col-form-label">Sèks</label>
    <div class="col-md-7">
  ...
  <div class="row row-bottom-margin">
    <label for="staticAge" class="col-md-5 col-form-label">Laj</label>
    <div class="col-md-7">
...
<div class = "col-md-5">
  <div class="row row-bottom-margin">
<label for="staticEmail" class="col-md-4 col-form-label">Non Gadyen</label>
<div class="col-md-8">
...
<div class="row row-bottom-margin">
<label for="staticEmail" class="col-md-4 col-form-label">Gadyen Imèl</label>
<div class="col-md-8">
...
<div class="row row-bottom-margin">
<label for="staticEmail" class="col-md-4 col-form-label">Gadyen Telefòn</label>
<div class="col-md-8">
