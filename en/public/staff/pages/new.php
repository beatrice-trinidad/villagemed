...
<div class="container">
  ...
  <div class="col-sm-12">
    ...
    <div class="col">
      ...
      <div style="height: 275px; width: 200px; float: right;" class="bg-white shadow">
      ...
      <div class="col-sm-10">
        <div class="form-group">
          <label for="pwd">Guardian's Email Address</label>
            <input type="Email" class="form-control" name="GRemail" id="inputPassword" placeholder="me@example.com" required>
        </div>
      </div>
    </div>
    <div class="row mb-4">
